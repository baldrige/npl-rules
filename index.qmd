...
This rules document covers most, but not all, rules in NPL. If rules are missing, owners may request that the rule be added to the document. Rule changes suggestions may be submitted to the NPL Directors, also serving as the Rules Committee (RC) by email at [npldirectors@googlegroups.com](mailto:npldirectors@googlegroups.com). For Winter Meeting rule considerations, please submit your proposal at [this link](http://bit.ly/nplwintermeetings).
