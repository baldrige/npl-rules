...
Teams may trade only players currently under contract, players to be named later (PTBNL),[^1] cash considerations, carried salary, released player salary obligations, draft picks, and IFA cap space. If you wish to trade something not on this list, it may or may not be allowed---check with the Directors.
